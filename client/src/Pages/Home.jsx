              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr className="border-b dark:border-gray-700">
                    ...
                    >
                      <Link to={`/journey/${data.jId}`}>{data.journey}</Link>
                    </th>
                    ...
                    <div
                      className={`${toggleDropDown} z-10 w-44  bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`}
                    >
